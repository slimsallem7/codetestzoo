 ...
 */
public class ZooHorizontalScrollView extends HorizontalScrollView {
	
	private ImageButton buttonSide;
	private MyOnGlobalLayoutListener listener;
	
    public ZooHorizontalScrollView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public ZooHorizontalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ZooHorizontalScrollView(Context context) {
        super(context);
        init(context);
    }
     ...
     */
    public void initViews(View[] children, int scrollToViewIdx, SizeCallback sizeCallback,ImageButton button) {
        // A ViewGroup MUST be the only child of the HSV
        ViewGroup parent = (ViewGroup) getChildAt(0);
        this.buttonSide = button;
        ...
        this.buttonSide.getViewTreeObserver().addOnGlobalLayoutListener(listener);
    }
...
//    }
    ...
    class MyOnGlobalLayoutListener  implements OnGlobalLayoutListener{
        ...
        public void onGlobalLayout() {
            ...
            final ZooHorizontalScrollView me = ZooHorizontalScrollView.this;

            // The listener will remove itself as a layout listener to the HSV
            me.buttonSide.getViewTreeObserver().removeGlobalOnLayoutListener(this);
