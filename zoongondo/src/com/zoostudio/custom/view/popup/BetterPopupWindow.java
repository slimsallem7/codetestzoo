...
public class BetterPopupWindow {
	 ...
	 */
	public BetterPopupWindow(View anchor,int mCurrentValue) {
		this.anchor = anchor;
		this.window = new PopupWindow(anchor.getContext());
		WindowManager manager = (WindowManager) this.anchor.getContext().getSystemService(Context.WINDOW_SERVICE);
		mWidthScreen = manager.getDefaultDisplay().getWidth();
		mWidthPopup = this.anchor.getContext().getResources().getDimensionPixelSize(R.dimen.dialog_change_distance_width);
		mPadding = (int) Math.floor((mWidthScreen - mWidthPopup)/2);
	 ...
	 * child views.
	 */
	protected void onCreate(int currentValue) {}
	...
	private void preShow() {
		...
		this.window.setWidth(mWidthPopup);
	 ...
	 */
	public void showLikePopDownMenu(int style) {
		this.showLikePopDownMenu(mPadding, 0,style);
	}
	 ...
	 */
	public void showLikePopDownMenu(int xOffset, int yOffset, int style) {
		this.preShow();
		this.window.setAnimationStyle(style);
