 ...
 * @version 0.1.0
 */
public class HorizontalPager extends ViewGroup implements
		ZooImageDishBorder.OnUnSelectedListener {
	/*
	...
	private ZooImageDishBorder mImageView1;
	private ZooImageDishBorder mImageView2;
	private ZooImageDishBorder mImageView3;
	...
	public void computeScroll() {
		if (mScroller.computeScrollOffset()) {
			...
			if (mOnScreenSwitchListener != null) {
				initListenerImageViews(mCurrentScreen);
	...
	private void initListenerImageViews(int position) {
		parent = this.getChildAt(position);
		mImageView1 = (ZooImageDishBorder) parent.findViewById(R.id.thumbDish1);
		mImageView2 = (ZooImageDishBorder) parent.findViewById(R.id.thumbDish2);
		mImageView3 = (ZooImageDishBorder) parent.findViewById(R.id.thumbDish3);
		mImageView4 = (ZooImageDishBorder) parent.findViewById(R.id.thumbDish4);

		mImageView1.setOnUnSelectedDish(this);
		mImageView2.setOnUnSelectedDish(this);
		mImageView3.setOnUnSelectedDish(this);
		mImageView4.setOnUnSelectedDish(this);

		setActionForImage(mImageView1, 0);
		setActionForImage(mImageView2, 1);
		setActionForImage(mImageView3, 2);
		setActionForImage(mImageView4, 3);
	}

	private void setActionForImage(final ZooImageDishBorder view,
			final int position) {
		if (view.getType() != ZooImageDishBorder.TYPE_NULL) {
			view.setOnClickListener(new OnShowDialog(view.getmImageLargeUrl(),
					view.getNameDish()));
		} else {
	...
	private class OnShowDialog implements OnClickListener {
		private String urlImageLarge;
		private String titleDish;

		public OnShowDialog(String urlImageLarge, String titleDish) {
		...
		public void onClick(View v) {
			mListener
					.onItemShowPopup(v, titleDish.toUpperCase(), urlImageLarge);
		}
	}
	...
	public void setOnItemClick(OnItemChangeListener listener) {
	...
	public void setData(ArrayList<DishItem> items) {
		...
		int totalPageView = this.getChildCount();
		totalPage -= totalPageView;
	...
	public void onUnSelectListener(View view, DishItem dishItem) {
		...
		mListener.onItemUnSelect(dishItem);
	}
}
